...
"""
获取所有股票全量信息，并保存在stock_basics.csv中
...
if os.path.exists("stock_basics.csv"):
    if os.system('mv stock_basics.csv basics_bak/stock_basics_`date "+%Y-%m-%d"`.csv') == 0:
...
df.to_csv("stock_basics.csv")  # 保存至stock_basics.csv文件中
